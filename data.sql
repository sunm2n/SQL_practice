...
-------------------------------------------------
-- SQL전문가가이드 2과목 제2절 CREATE TABLE.
-------------------------------------------------
rem  DROP TABLES
drop table PLAYER;
drop table SCHEDULE;
...
COMMENT ON TABLE TEAM IS 'K-리그 TEAM';
COMMENT ON COLUMN TEAM.TEAM_ID IS '팀 고유 ID';
COMMENT ON COLUMN TEAM.REGION_NAME IS '연고지 명';
COMMENT ON COLUMN TEAM.TEAM_NAME IS '한글 팀 명';
COMMENT ON COLUMN TEAM.E_TEAM_NAME IS '영문 팀 명';
COMMENT ON COLUMN TEAM.ORIG_YYYY IS '창단년도';
COMMENT ON COLUMN TEAM.STADIUM_ID IS '구장 고유 ID';
COMMENT ON COLUMN TEAM.ZIP_CODE1 IS '우편번호 앞 3자리';
COMMENT ON COLUMN TEAM.ZIP_CODE2 IS '우편번호 뒷 3자리';
COMMENT ON COLUMN TEAM.ADDRESS IS '주소';
COMMENT ON COLUMN TEAM.DDD IS '지역번호';
COMMENT ON COLUMN TEAM.TEL IS '전화번호';
COMMENT ON COLUMN TEAM.FAX IS '팩스번호';
COMMENT ON COLUMN TEAM.HOMEPAGE IS '홈페이지';
COMMENT ON COLUMN TEAM.OWNER IS '구단주';
...
COMMENT ON TABLE PLAYER IS 'K-리그 선수';
COMMENT ON COLUMN PLAYER.PLAYER_ID IS '선수ID';
COMMENT ON COLUMN PLAYER.PLAYER_NAME IS '선수명';
COMMENT ON COLUMN PLAYER.TEAM_ID  IS '팀ID';
COMMENT ON COLUMN PLAYER.E_PLAYER_NAME IS '영문선수명';
COMMENT ON COLUMN PLAYER.NICKNAME IS '선수별명';
COMMENT ON COLUMN PLAYER.JOIN_YYYY IS '입단년도';
COMMENT ON COLUMN PLAYER.POSITION IS '포지션';
COMMENT ON COLUMN PLAYER.BACK_NO IS '등번호';
COMMENT ON COLUMN PLAYER.NATION  IS '국적';
COMMENT ON COLUMN PLAYER.BIRTH_DATE IS '생년월일';
COMMENT ON COLUMN PLAYER.SOLAR IS '양/음';
COMMENT ON COLUMN PLAYER.HEIGHT IS '신장';
COMMENT ON COLUMN PLAYER.WEIGHT IS '몸무게';


-------------------------------------------------------------------
-- SQL전문가가이드 2과목 제2절 CREATE TABLE. - 실습용 데이터 생성
-------------------------------------------------------------------
